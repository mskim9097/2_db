...
INSERT INTO USER_GRADE (GRADE_CODE, GRADE_NAME) VALUES(40, '슈퍼회원');
UPDATE USER_GRADE SET GRADE_NAME = '하이퍼회원' WHERE GRADE_NAME = '슈퍼회원';
DELETE FROM USER_GRADE WHERE GRADE_NAME = '하이퍼회원';
TRUNCATE TABLE USER_GRADE;
...
CREATE TABLE EMP(
	...
	USER_ID VARCHAR2(30) CONSTRAINT EMP_ID_U UNIQUE, -- 컬럼에 입력값에 대해서 중복을 제한하는 제약조건, NULL값은 중복 가능
